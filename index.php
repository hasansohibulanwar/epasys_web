        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="main/login.php" target="_blank" class="btn btn-primary-gradient rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Get Started</a>
                </div>
            </nav>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4"># Electronic Parkir System</h1>
                        <p class="mb-4">Epasys adalah aplikasi parkir kendaraan untuk mahasiswa berbasis qr code. Aplikasi ini dibuat untuk menggantikan proses penulisan manual nomor polisi pada kartu parkir agar menjadi lebih efesiensi dan simpel.</p>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Jl. KH. Wahid Hasyim No 41, Bondowoso - Jawa Timur</p>
                        <!-- <p><i class="fa fa-phone-alt me-3"></i>+6282226079857</p>
                        <p><i class="fa fa-envelope me-3"></i>epaysdev@gmail.com</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-phone-alt me-3"></i>+6282226079857</p>
                        <p><i class="fa fa-envelope me-3"></i>epasysdev@gmail.com</p>
                        <div class="d-flex pt-2">
                            <a class="btn btn-outline-light btn-social" href=""><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-social" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social" href=""><i class="fab fa-instagram"></i></a>
